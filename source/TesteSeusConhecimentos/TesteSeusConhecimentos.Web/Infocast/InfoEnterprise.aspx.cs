    ...
    public partial class InfoEnterprise : System.Web.UI.Page
    {
        ...
        private void UpdateForm()
        {
            ...
            if (enterprise != null)
            {
                ...
                txtStreetAddress.Text = enterprise.StreetAddress;
        ...
        {
            Enterprise enterprise = new Enterprise(idEnterprise, txtStreetAddress.Text, txtCity.Text, txtState.Text, txtZipCode.Text, txtCorporateActivity.Text);
