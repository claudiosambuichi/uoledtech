<%@ Page Title="Empresas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Enterprise.aspx.cs" Inherits="TesteSeusConhecimentos.Web.Infocast.Enterprise" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <asp:GridView ID="grdUsers" AutoGenerateColumns="False" runat="server" CssClass="table table-bordered table-hover"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Atividade Coroprativa">
                <ItemTemplate>
                    <asp:Label ID="lbCorporateActivit" Text='<%#Eval("CorporateActivit") %>' runat="server" />
                </ItemTemplate>
            </asp:TemplateField>
