<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InfoEnterprise.aspx.cs" Inherits="TesteSeusConhecimentos.Web.Infoenterprise.InfoEnterprise" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <div class="form-width"> 
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtZipCode" CssClass="form-control" runat="server" MaxLength="8"></asp:TextBox>
        </div>
        <div class="form-group">
            <asp:Label ID="lbCorporateActivity" runat="server" Text="Label">Atividade Corporativa:</asp:Label>
